...
const prismaAdapter = {
  user: {
    findMany: async (opts = {}) => {
      let query = User.find(opts.where || {});
    ...
    findUnique: async (opts) => opts.where?.id ? User.findById(opts.where.id) : User.findOne(opts.where),
    create: async (opts) => User.create(opts.data),
    update: async (opts) => User.findByIdAndUpdate(opts.where.id, opts.data, { new: true }),
    count: async (opts = {}) => User.countDocuments(opts.where || {}),
    delete: async (opts) => User.findByIdAndDelete(opts.where.id),
  },
  product: {
    findMany: async (opts = {}) => {
      let query = Product.find(opts.where || {});
      if (opts.orderBy) Object.keys(opts.orderBy).forEach(key => query.sort({ [key]: opts.orderBy[key] === 'desc' ? -1 : 1 }));
      if (opts.take) query.limit(opts.take);
      if (opts.skip) query.skip(opts.skip);
      return query;
    },
    findUnique: async (opts) => opts.where?.id ? Product.findById(opts.where.id) : Product.findOne(opts.where),
    create: async (opts) => Product.create(opts.data),
    update: async (opts) => Product.findByIdAndUpdate(opts.where.id, opts.data, { new: true }),
    count: async (opts = {}) => Product.countDocuments(opts.where || {}),
  ...
  order: {
    findMany: async (opts = {}) => {
      let query = Order.find(opts.where || {});
      if (opts.orderBy) Object.keys(opts.orderBy).forEach(key => query.sort({ [key]: opts.orderBy[key] === 'desc' ? -1 : 1 }));
      if (opts.take) query.limit(opts.take);
      if (opts.skip) query.skip(opts.skip);
      return query.lean();
    },
    findUnique: async (opts) => opts.where?.id ? Order.findById(opts.where.id).lean() : Order.findOne(opts.where).lean(),
    create: async (opts) => Order.create(opts.data),
    update: async (opts) => Order.findByIdAndUpdate(opts.where.id, opts.data, { new: true }).lean(),
    count: async (opts = {}) => Order.countDocuments(opts.where || {}),
  ...
  coupon: {
    findMany: async (opts = {}) => {
      let query = Coupon.find(opts.where || {});
      if (opts.orderBy) Object.keys(opts.orderBy).forEach(key => query.sort({ [key]: opts.orderBy[key] === 'desc' ? -1 : 1 }));
      if (opts.take) query.limit(opts.take);
      return query;
    },
  ...
  address: {
    findMany: async (opts = {}) => Address.find(opts.where || {}),
    ...
    updateMany: async (opts) => Address.updateMany(opts.where, opts.data),
    delete: async (opts) => Address.findByIdAndDelete(opts.where.id),
  },
  returnRequest: {
    findMany: async (opts = {}) => ReturnRequest.find(opts.where || {}),
    findUnique: async (opts) => ReturnRequest.findById(opts.where.id),
    findFirst: async (opts) => ReturnRequest.findOne(opts.where || {}),
  ...
  contactForm: {
    findMany: async (opts = {}) => ContactForm.find(opts.where || {}),
  ...
  review: {
    findMany: async (opts = {}) => Review.find(opts.where || {}),
  ...
  userWishlist: {
    findMany: async (opts = {}) => UserWishlist.find(opts.where || {}),
